...
static WORD TRK_LADDER_STRT[] = {TUNE_OFFBEAT1,TUNE_OFFBEAT2,TUNE_OFFBEAT3,TUNE_OFFBEAT4,0};
...
void create_base_object(void)
{
	...
	(OBJECT *)current_proc->pa10=obj;			// new last obj
...
void process_a_ladder(MHE_ORD *pa0,short pa2)
{
	...
	do
	{
		...
		(OBJECT *)current_proc->pa7=obj;				// prev object
		obj=obj->olink;
		if (obj==NULL)
			break;
