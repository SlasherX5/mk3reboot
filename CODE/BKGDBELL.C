...
void fall_down_bell_tower(void)
{
	...
	(FUNC)current_proc->pa6=bell_fall_scan;
...
void bell_fall_scan(void)
{
	...
	do
	{
		a1=((OBJECT *)pa0)->oypos.u.intpos=((OBJECT *)pa0)->oypos.u.intpos+ONE_FLOOR;
		a1+=((OBJECT *)pa0)->osize.u.ypos;
		if (a1>=a7)
			a7=a1;				// new lowest point

		(OBJECT *)pa0=((OBJECT*)pa0)->olink;
	}
	while((OBJECT *)pa0!=NULL);
