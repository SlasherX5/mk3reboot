...
void thrown_by_sonya(void)
{
	...
	flight(obj,SCX(0x70000),SCY(0),SCY(0x6000),6,-1);
...
void jax_multi_slam_pose(WORD offset)
{
	...
	((ADDRESS *)(current_proc->pa11))+=(offset+(offset<<1));	// his matching "slammed"
...
******************************************************************************/
 WORD read_lp_tick_state(OBJECT *obj)
{
	WORD result;
...
void do_back_breaker(void)
{
	...
	(FUNC)current_proc->pa6=bb_fall_call;
...
void body_slam_init(OBJECT *obj)
{
	...
	(OBJECT *)current_proc->pa10=current_proc->pdata.p_otherguy;						// a10 = his obj
