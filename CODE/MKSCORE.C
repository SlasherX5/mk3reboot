...
short p1_powerbar_names[][3] =
{
	{P1_NAME_SPEC,SCY(0x1a),2+SCX(0x19)},
	{P1_NAME_SPEC,SCY(0x1a),2+SCX(0x19)},
	{P1_NAME_SPEC,SCY(0x1a),2+SCX(0x19)},
	{P1_NAME_SPEC,SCY(0x1a),2+SCX(0x19)},
	{P1_NAME_SPEC,SCY(0x1a),2+SCX(0x19)},
...
short p2_powerbar_names[][3] =
{
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0153)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x014c)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x015a)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0132)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x013c)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0140)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0149)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0149)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0149)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0139)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x014f)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0149)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0123)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x013d)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0149)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0144)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0132)-2},
	{P2_NAME_SPEC,SCY(0x1a),SCX(0x0127)-2}
};
...
void setup_score_ram(void)
{
	...
	SET_SCORE_RAM(sr_ptr,p1_powerbar_names[p1_name_char][2],p1_powerbar_names[p1_name_char][1],p1_powerbar_names[p1_name_char][0],1);		// p1 name
	sr_ptr++;
	SET_SCORE_RAM(sr_ptr,p2_powerbar_names[p2_name_char][2],p2_powerbar_names[p2_name_char][1],p2_powerbar_names[p2_name_char][0],1);		// p2 name
	sr_ptr++;
...
//WIN95 COMPENSATE FOR PLAYSTATION ALIGN BUG
//WIN95					setXYWH(cdb->curr_prim,sr_ptr->x0+2,sr_ptr->y0+1,(p1_bar_view*80/100)-1,POWERBAR_Y_SIZE);
					
					setXYWH(cdb->curr_prim,sr_ptr->x0+1,sr_ptr->y0+1,(p1_bar_view*80/100),POWERBAR_Y_SIZE);
				...
				case P2_BACKPWR_SPEC:
					cp=control_panel_info+ENERGY_FILL_BAR;
//WIN95 COMPENSATE FOR PLAYSTATION ALIGN BUG
//WIN95					setXYWH(cdb->curr_prim,sr_ptr->x0+1-(p2_bar_view*80/100),sr_ptr->y0+1,(p2_bar_view*80/100)-1,POWERBAR_Y_SIZE);
					
					setXYWH(cdb->curr_prim,sr_ptr->x0-(p2_bar_view*80/100),sr_ptr->y0+1,(p2_bar_view*80/100),POWERBAR_Y_SIZE);
					cdb->curr_prim->clut=score_pal;
					cdb->curr_prim->tpage=control_floor_tpage;
					SetSemiTrans(cdb->curr_prim, 0);
					setUVWH(cdb->curr_prim,cp->u0,cp->v0,cp->w,cp->h);					
				...
				case P1_NAME_SPEC:
					sprt=&(cdb->cp[sindex++]);
					sprt->clut=score_pal;
					sprt->u=P1_NAME_TXT_X;
					sprt->v=P1_NAME_TXT_Y;
				...
				case P2_NAME_SPEC:
					sprt=&(cdb->cp[sindex++]);
					sprt->clut=score_pal;
					sprt->u=P2_NAME_TXT_X;
					sprt->v=P2_NAME_TXT_Y;
