...
{
	reaction_start(REACT_START,NULL,0,NULL);
	createBLOOD_Proc(BLOOD_SAW_BLOOD);
...
void r_zoom_flipped(void)
{
	...
	damage_to_me(ZOOM_DAMAGE,current_proc->pa8);
	land_on_my_back();
}
...
void r_pounce2(void)
{
	...
	do
	{
		...
		((ADDRESS *)current_proc->pa10)++;			// toggle frame 2
...
void r_hi_kick(void)
{
	...
	createBLOOD_Proc(BLOOD_FACE_PUNCH);
...
void sweep3(void)
{
	...
	{
		/* drone code */
//WIN95: KULDGE THIS CAUSES THE DUDES TO STAND UP!!!! 
...
{
	createBLOOD_Proc(BLOOD_ROUNDHOUSE);
...
/******************************************************************************
 Function:  void cc_hi_punch(void)
...
/******************************************************************************
 Function:  void cc_lo_punch(void)
...
/******************************************************************************
 Function:  void cc_block_sweep(void)
...
/******************************************************************************
 Function:  cc_block_avoid_corner(void)
...
/******************************************************************************
 Function:  void cc_ken_masters(void)
...
void b_uppercut(void)
{
	...
	reaction_start(REACT_BLOCK,NULL,0,cc_ken_masters);
...
WORD getup_speeds[]= {4,4,4,4,4,4,4,2,4,4,4,4,4,4,4,4,4,4,4,4,4,4};
...
void gup2(WORD ani)
{
	...
	(WORD *)current_proc->pa11=getup_speeds;		// set for drone process
...
{
	if (winner_status != 0 && winner_status !=3 && winner_status!=current_proc->procid)
	{
		/* i lose --> stay down */
...
/******************************************************************************
 Function:  void shake_n_sound(void)
...
void shake_on_my_back(WORD anispeed,WORD scount)
{
	...
	(ADDRESS *)current_proc->pa11=(ADDRESS *)current_proc->pa9;
...
/******************************************************************************
 ...
 Description:	block scream react
******************************************************************************/
void b_scream(void)
{
	(LONG)current_proc->a0=SCX(0x40000);
...
{
	if (p1_obj==pa8)
		return((WORD *)current_proc->pa0=p1_hitq);
	else return((WORD *)current_proc->pa0=p2_hitq);
}
